          ...
          <li class="">
            ...
            <b-collapse id="collapse-1">
              <ul class="list-unstyled" id="PerfilSubmenu">
                <li>
                  <a href="#" @click="cambiarComponenteOrganizacion('PerfilPaciente')"
                    >Tu perfil</a
                  >
                </li>
                <li>
                  <a href="#" @click="cambiarComponenteOrganizacion('ActualizarPaciente')"
                    >Actualizar datos</a
                  >
                </li>
              </ul>
          ...
          <li class="">
            ...
            <b-collapse id="collapse-2">
              <ul class=" list-unstyled" id="citasSubmenu">
                <li>
                  <a href="#" @click="cambiarComponenteOrganizacion('NuevaCitaPaciente')"
                    >Nueva cita</a
                  >
                </li>
                <li>
                  <a
                    href="#"
                    @click="cambiarComponenteOrganizacion('ActualizarCitaPaciente')"
                    >Actualizar cita</a
                  >
                </li>
              </ul>
          ...
          <li class="">
            ...
            <b-collapse id="collapse-3">
              ...
              >
                <li>
                  <a href="#"
                  @click="cambiarComponenteOrganizacion('CitaPendientePaciente')">Citas pendientes</a>
                </li>
                <li>
