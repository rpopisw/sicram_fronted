<template>
  <modal
    name="mod-ver-receta-medica-doctor"
    transition="pop-out"
    :width="1020"
    :focus-trap="true"
    :height="600"
    ...
    <div class="modal-contenido">
      <vue-custom-scrollbar class="scroll-area" :settings="settings">
        <div id="inprime">
          ...
          <div v-if="getRecetaCitaDoctor != null">
            <div class="row">
              <div class="col-md-5">
                <div class="row">
                  <div class="col-md-3">
                  ...
                  <div class="col-md-9">
                    <label for="">{{
                      getRecetaCitaDoctor.nombres_apellidos
                    }}</label>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-7">
                <label class="mayuscula">{{
                  getRecetaCitaDoctor.nombres_apellidos
                }}</label>
              </div>
            </div>
          </div>
          <div class="receta" v-if="getRecetaCitaDoctor != null">
            <div class="tabla">
              ...
              <div class="lista-medica">
                <div
                  ...
                  v-for="(element, id) of getRecetaCitaDoctor.medicamentos"
                  :key="id"
                >
                  <div class="col-md-3">
          ...
          <div class="row mt-3 mb-1" v-if="getRecetaCitaDoctor != null">
            <div class="col-md-4">
              <div class="row">
                <div class="col-md-5">
                ...
                <div class="col-md-7">
                  <label>{{ getRecetaCitaDoctor.fecha_expedicion }}</label>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="row">
                ...
                <div class="col-md-7">
                  <label>{{ getRecetaCitaDoctor.valida_hasta }}</label>
                </div>
              </div>
            </div>
            <div class="col-md-4" style="text-align: center;">
              <div>
                <img class="firma" :src="getRecetaCitaDoctor.firma" alt="" />
              </div>
              <div
                class=" mt-1"
        ...
        <div>
          <div class="container" v-if="getRecetaCitaDoctor === null">
            <div
              class="mensaje"
        ...
        <div class="botones">
          <button
            @click="$modal.hide('mod-ver-receta-medica-doctor')"
            type="button"
            class="btn boton"
          >
            Salir
...
export default {
  ...
  methods: {},
  computed: {
    ...mapGetters(["getRecetaCitaDoctor", "getDatosDoctor"]),
  },
};
</script>
